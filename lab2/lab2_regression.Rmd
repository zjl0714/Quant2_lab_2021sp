...
plot(density(lm_est), main = "Bias of the group-mean-difference estimator", xlab = "ATE estimates", xlim = c(-2, 8))
abline(v = ATE, lty = 2)
```
...
# Efficiency from using covariates
```{r cov1, echo=FALSE}
plot(density(lm_est_cov), main = "Bias of the estimator with covariate adjustment", xlab = "ATE estimates", xlim = c(-2, 8))
abline(v = ATE, lty = 2)
```

# Efficiency from using covariates
```{r cov2, echo=FALSE}
plot(density(lm_est_lin), main = "Bias of the Lin's regression", xlab = "ATE estimates", xlim = c(-2, 8))
abline(v = ATE, lty = 2)
```
...
plot(density(lm_est), main = "Bias of the regression estimator", xlab = "ATE estimates", xlim = c(-2, 8))
abline(v = ATE, lty = 2)
```

# Partial regression
```{r cov5, echo=FALSE}
plot(density(lm_est_par), main = "Bias of the partial regression", xlab = "ATE estimates", xlim = c(-2, 8))
abline(v = ATE, lty = 2)
```
...
plot(density(ATE_est), main = "Bias of the group-mean-difference estimator", xlab = "ATE estimates", xlim = c(-4, 16))
...
plot(density(ATE_est), main = "Bias of the regression estimator", xlab = "ATE estimates", xlim = c(-4, 16))
abline(v = ATE, lty = 2, col = "red")
abline(v = mean(ATE_est), lty = 3)
```
...
plot(density(ATE_est), main = "Bias of the Horvitz-Thompson estimator", xlab = "ATE estimates", xlim = c(-4, 16))
abline(v = ATE, lty = 2, col = "red")
abline(v = mean(ATE_est), lty = 3)
```
